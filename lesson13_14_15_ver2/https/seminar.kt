...
fun main() {
    ...
    println("\n=== GET /posts/9999 ===")
	val errorUrl = URL("https://jsonplaceholder.typicode.com/posts/9999")
...
fun main() {
    ...
    val encheader=encoder.encodeToString(header.toByteArray())
	val encpayload=encoder.encodeToString(payload.toByteArray())
